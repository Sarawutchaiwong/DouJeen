# DouJeen Bibliography

DouJeen separates its sources into three layers: dictionary data, factual
connections, and interaction inspiration. A recipe is never treated as proof of
a scientific equation; it is a compact learning analogy backed by the note and
source shown in the discovery notebook.
...
finite, reviewed recipe graph so every Chinese word and learning note can be
verified.
